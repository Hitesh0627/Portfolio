		...
		<div className='area relative z-0 bg-black w-screen h-screen'>
			...
			<div className='hero relative h-[calc(100vh)] flex justify-center items-center text-white' id='hero'>
				<div className='pt-4 h-36 backdrop-blur-sm rounded-3xl'>
					...
					<p className='mt-3 text-xl'>I am passionate about learning Data Structures and Algorithms, adept at building scalable iOS applications, and possess strong communication skills and leadership qualities."</p>
				</div>      
			</div>
			<Footer/>
		</div>	
